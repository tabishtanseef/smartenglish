...
//var _color = "rgba(0, 0, 255, 0.3)";

canvas.on('mouse:down', function(o){
	
	console.log(_color, ' color down');
...
canvas.on('mouse:move', function(o){
	...
	if(activeTool == 2)
	{
		...
		if(_color == "show-tools-2")
		{
			_color = "rgba(0, 0, 255, 0.3)";
		}
...
canvas.on('mouse:up', function(o){
	...
	if(activeTool == 2) {
		...
		//canvas.item(currentItem).stroke = _color;
		
		
		//canvas.freeDrawingBrush.color = _color;
		
		//console.log(_color,canvas.freeDrawingBrush, 'afeter');
